...
RSpec.describe UsersController, type: :request do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get "/users/#{user.to_param}", headers: valid_headers
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested user" do
        user = User.create! valid_attributes
        put "/users/#{user.to_param}", params: {user: new_attributes}, headers: valid_headers
        user.reload
      ...
      it "renders a JSON response with the user" do
        ...
        put "/users/#{user.to_param}", params: {id: user.to_param, user: valid_attributes}, headers: valid_headers
